...
declare const _default: (params: ButtonStylesParams, options?: import("@mantine/styles").UseStylesOptions<"icon" | "label" | "root" | "inner" | "leftIcon" | "rightIcon" | "centerLoader">) => {
    classes: Record<"icon" | "label" | "root" | "inner" | "leftIcon" | "rightIcon" | "centerLoader", string>;
    cx: (...args: any) => string;
    theme: MantineTheme;
};
