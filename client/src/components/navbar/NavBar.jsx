...
export default function NavBar() {
  return (
    <nav class="bg-white px-2 sm:px-4 py-2.5 mb-6 shadow-md">
      <div class="container px-12 flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-cta">
          <ul class="flex p-4 mt-4 border border-gray-100 md:flex-row md:space-x-4  md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
