...
export default function NavBar() {
  return (
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 mb-6 dark:bg-gray-900">
      <div class="container px-12 flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-cta">
          <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            {titlePage.map((index, i) => (
              <li key={i}>
                <Link to={`${index.directname}`} class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">{index.page}</Link>
              </li>
            ))}
          </ul>
        </div>
