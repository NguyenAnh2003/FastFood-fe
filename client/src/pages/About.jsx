          ...
          <div class="grid gap-12 items-center md:grid-cols-3">
            <div class="space-y-4 text-center">
              <img
                ...
                src="https://images.news18.com/ibnlive/uploads/2021/10/gus-fring--16336703954x3.jpg"
                alt="Huy"
                loading="lazy"
                width="640"
                height="805"
            ...
            <div class="space-y-4 text-center">
              <img
                class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
                src="https://cdn.80.lv/api/upload/content/03/images/6304681703cec/widen_920x0.jpeg"
                alt="NA"
                loading="lazy"
                width="1000"
                height="667"
